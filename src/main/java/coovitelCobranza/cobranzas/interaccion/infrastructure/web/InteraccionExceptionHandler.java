...
public class InteraccionExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInteractionNotFoundException(InteractionNotFoundException ex) {
    ...
    @ExceptionHandler(InteractionBusinessException.class)
    public ResponseEntity<Map<String, Object>> handleInteractionBusinessException(InteractionBusinessException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
