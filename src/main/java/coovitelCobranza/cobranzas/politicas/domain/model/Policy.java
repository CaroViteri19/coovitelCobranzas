...
public class Policy {
    ...
    private final TipoCobro collectionType;
    ...
    public static Policy create(Long strategyId, TipoCobro collectionType, String action) {
        return new Policy(null, strategyId, collectionType, 0, 30, action, true);
    }

    public static Policy crear(Long strategyId, TipoCobro collectionType, String action) {
    ...
    public TipoCobro getCollectionType() { return collectionType; }
    public TipoCobro getTipoCobro() { return collectionType; }
