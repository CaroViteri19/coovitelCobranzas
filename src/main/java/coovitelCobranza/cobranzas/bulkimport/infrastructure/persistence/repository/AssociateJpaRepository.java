...
import coovitelCobranza.cobranzas.bulkimport.infrastructure.persistence.entity.AssociateJpaEntity;
...
/**
 * Repositorio Spring Data JPA para {@link AssociateJpaEntity}.
 *
 * <p>Usado exclusivamente para <b>queries de unicidad</b> antes de la inserción.
 * La inserción masiva se delega a {@link AssociateRepositoryImpl} via JdbcTemplate.
 */
@Repository
public interface AssociateJpaRepository extends JpaRepository<AssociateJpaEntity, Long> {
