package coovitelCobranza.cobranzas.cargamasiva.infrastructure.parser;
 ...
 * </ul>
 *
 * <p><b>Evolución futura:</b> Puede extenderse para devolver un {@code Stream<AsociadoRowDTO>}
 * lazy cuando se integre con Spring Batch (ItemReader pattern).
 */
@Component
public class CsvAsociadoParser {

    private static final Logger log = LoggerFactory.getLogger(CsvAsociadoParser.class);
    ...
    private static final int  MAX_COLUMNS    = AsociadoRowDTO.EXPECTED_COLUMNS;
     ...
     */
    public List<AsociadoRowDTO> parse(InputStream inputStream) throws IOException {
        List<AsociadoRowDTO> rows = new ArrayList<>();
    ...
    private AsociadoRowDTO parseLine(String line, int rowNumber) {
