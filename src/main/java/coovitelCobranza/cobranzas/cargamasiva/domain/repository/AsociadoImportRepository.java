package coovitelCobranza.cobranzas.cargamasiva.domain.repository;
...
/**
 * Puerto (port) del repositorio de AsociadoImport.
 *
 ...
 */
public interface AsociadoImportRepository {
     ...
     */
    void batchInsert(List<AsociadoImport> asociados, int chunkSize);
