package coovitelCobranza.cobranzas.cargamasiva.domain.service;
 ...
 */
@Service
public class AsociadoImportValidationService {
     ...
     */
    public List<RowErrorDTO> validateAll(List<AsociadoRowDTO> rows) {
    ...
    private List<RowErrorDTO> validateRow(AsociadoRowDTO row) {
        List<RowErrorDTO> errors = new ArrayList<>();
        int r = row.rowNumber();
     ...
     */
    private List<RowErrorDTO> validateIntraFileUniqueness(List<AsociadoRowDTO> rows) {
        List<RowErrorDTO> errors = new ArrayList<>();
