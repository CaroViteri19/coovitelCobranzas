package coovitelCobranza.cobranzas.cargamasiva.domain.model;
...
public class AsociadoImport {
    ...
    // ── Constructor privado ───────────────────────────────────────────────────
    private AsociadoImport(Long id,
     ...
     */
    public static AsociadoImport create(String tipoId, String numDocumento,
    ...
    public static AsociadoImport reconstruct(Long id, String tipoId, String numDocumento,
                                             String nombreCompleto, String numObligacion,
                                             BigDecimal saldoTotal, int diasMora,
                                             LocalDate fechaVenc, String telefono1,
                                             String email, String telefono2, String ciudad,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AsociadoImport a)) return false;
    ...
    public String toString() {
        return "AsociadoImport{doc=%s, obligacion=%s, nombre=%s}"
